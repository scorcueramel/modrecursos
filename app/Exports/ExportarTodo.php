...
class ExportarTodo implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
     return[
        "Codigo","Tipo Documento","Nro. Documento","Nombres y Apellidos","Reg. Laboral","Und. Organica","Inicio Labores","Estado","Concepto","Inicio Permiso","Fin Permiso","Documento","Periodo","Observaciones"
     ];
    }
}
