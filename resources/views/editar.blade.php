                        ...
                        <form action="{{route('update',$tp->id)}}" method="GET">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="observaciones" id="observaciones" value="{{ $tp->comentario }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="documento_ref">Documento Sustentario</label>
                                    <input type="text" class="form-control" name="documento_ref" id="documento_ref" value="{{ $tp->documento }}">
                                </div>
                            </div>
                            <div class="form-row">
